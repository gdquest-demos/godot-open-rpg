...
OpenRPG is a tool and a demo to create Role Playing Games with turn-based combat. It's made with Godot 3.1 ([alpha 3](https://godotengine.org/article/dev-snapshot-godot-3-1-alpha-3)).
